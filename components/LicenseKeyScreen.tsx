                        ...
                        <form onSubmit={handleProSubmit} className="flex-grow flex flex-col">
                            <div className="mb-6 flex-grow">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-black/20 border border-teal-medium rounded-md text-[#F2EFE8] placeholder-teal-light/30 focus:outline-none focus:ring-2 focus:ring-accent transition-all font-mono tracking-wider"
